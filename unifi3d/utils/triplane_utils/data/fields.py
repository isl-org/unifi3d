...
import numpy as np
import trimesh
from unifi3d.utils.triplane_utils.data.core import Field
from unifi3d.utils.triplane_utils.utils import binvox_rw
from unifi3d.utils.triplane_utils.common import coord2index, normalize_coord
...
class PointsField(Field):
    ...
    def load(self, model_path, idx, category, data_saved=True):
        """Loads the data point.
        ...
        #     save_np_pointcloud(occ, path, "occ_full")
        #     save_np_pointcloud(unocc, path, "unocc_full")
        return data
...
class PointCloudField(Field):
    ...
    def load(self, model_path, idx, category, data_saved=True):
        ...
        if not data_saved:
            ...
            save_np_pointcloud(points, path, "pcl_full")
        return data
