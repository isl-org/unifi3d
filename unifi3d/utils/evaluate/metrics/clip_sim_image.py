...
class CLIPSimilarityImage(Base3dMetric):
    """
    Computes the average cosine similarity between the CLIP embeddings of the
    image prompt and renders of an object.
    """
    ...
    def __call__(self, image_prompt, renders_path: str):
        ...
        """
        # Read image prompt
        prompt_emb = self.model.encode(image_prompt.convert("RGB"))
        ...
        for imf in imagefiles:
            ...
            cos_scores = self.loss_fn(prompt_emb, img_emb)
